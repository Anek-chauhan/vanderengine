...
const Contact_us_page = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://vanderenginestransmissions.com/api/leads', {
        method: 'POST',
        headers: {
          ...
          <form onSubmit={handleSubmit}>
            <Row>
              ...
              <div className={styles["main_headline-form-group"]}>
                ...
                <div className="main_headline-form-group checkbox">
                <input
                  type="checkbox"
                  name="agreed"
                ...
                />
                <label>
                By checking this box you agree to receive recurring messages from Vander Engines, Reply STOP to Opt out. Reply HELP for help. Message frequency varies. Message and data rates may apply. Carriers are not liable for delayed or undelivered messages. No mobile information will be shared with third parties/affiliates for marketing/promotional purposes. All OPT-IN requests include text messaging originator opt-in data and consent; this information will not be shared with third parties.
                </label>
              </div> 
